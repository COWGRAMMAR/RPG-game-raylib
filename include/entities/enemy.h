...
constexpr int SPAWN_PINPOINT_NORMAL_MIN = 0;  // 0 (testing)
constexpr int SPAWN_PINPOINT_NORMAL_MAX = 0;  // 0 (testing)
constexpr int SPAWN_PINPOINT_ELITE_MIN = 0;   // 0 (testing)
constexpr int SPAWN_PINPOINT_ELITE_MAX = 0;   // 0 (testing)
constexpr int SPAWN_RECT_NORMAL_MIN = 1;      // 1 (testing)
constexpr int SPAWN_RECT_NORMAL_MAX = 1;      // 1 (testing)
constexpr int SPAWN_RECT_ELITE_MIN = 0;       // 0 (testing)
constexpr int SPAWN_RECT_ELITE_MAX = 0;       // 0 (testing)
